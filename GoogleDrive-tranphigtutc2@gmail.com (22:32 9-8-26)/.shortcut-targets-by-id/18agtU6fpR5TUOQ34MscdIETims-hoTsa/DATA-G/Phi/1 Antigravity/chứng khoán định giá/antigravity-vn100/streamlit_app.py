...
try:
    ...
    if "company" in st.session_state:
        ...
        with tab5:
            ...
            st.caption("💡 Sử dụng đầy đủ thanh công cụ phía góc trên bên phải biểu đồ để vẽ đường xu hướng, khối hộp, hình tròn và chỉ báo kỹ thuật.")
            from valuation.views.tradingview_chart import render_tradingview_widget
            render_tradingview_widget(company.ticker, height=680, key_suffix="tab5")
    else:
